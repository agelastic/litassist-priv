...
Pursue misleading conduct claim while simultaneously filing ombudsman complaint. Hold breach of contract as fallback if primary strategy fails."""
        ...
        self.mock_orthodox_client.complete.return_value = (self.orthodox_response, {"total_tokens": 500})
        self.mock_unorthodox_client.complete.return_value = (self.unorthodox_response, {"total_tokens": 400})
        self.mock_analysis_client.complete.return_value = (self.analysis_response, {"total_tokens": 300})
    ...
    def test_brainstorm_with_research_files(self, mock_factory_core, mock_factory_orth, mock_factory_unorth, mock_factory_analysis):
        ...
        with self.runner.isolated_filesystem():
            ...
            result = self.runner.invoke(cli, [
                ...
                "--side", "plaintiff",
                "--area", "commercial",
                "--research", "research1.txt",
                "--research", "research2.txt"
            ])
