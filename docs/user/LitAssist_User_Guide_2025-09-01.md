...
- [Y] **Zero-tolerance citation verification** - All legal references validated against Jade.io via Google Custom Search
- [Y] **Real-time online validation** - real-time queries via Google Custom Search verify case existence on Jade.io during generation
...
**What it verifies**:
- **Australian Cases**: Checks against Jade.io via Google CSE in real time
...
**How it works**:
- Performs real-time Google CSE queries to verify existence on Jade.io
...
- Would check Jade.io but validation already flagged issues
...
- Validates all case citations against Jade.io via Google CSE
