...
run(["litassist", "extractfacts", "interim_orders_april2026.pdf",
     "contravention_application_feb2026.pdf"])
# === Phase 2: Research Interstate Relocation Law ===
run(["litassist", "lookup", "best interests paramount consideration ...",
...
- Use the generated runner as a starting point; review and adjust commands before
