...
- Reference Memory Bank for all session context and planning Memory Bank initialized with core context, patterns, architecture, and technical setup
+ - Strategy command now correctly parses strategies file input (fixed parser handling)
